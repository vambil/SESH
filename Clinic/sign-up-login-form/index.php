...
<?php
 ...
 ?>
  <div class="form">
      ...
      <div class="tab-content">
        ...
        <div id="signup">
          ...
          <div class="field-wrap">
            <label>
            </br></br>Country<span class="req">*</span>
            </label>
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
    ...
    <!-- ADMIN IS EDITING YOUR USER INFORMATION -->
    ...
    <div class="form">
        ...
        <div class="top-row">
          <div class="field-wrap">
            ...
            <input type="text" name="first" required autocomplete="off" value="<?php echo $user_row['user_first']; ?>" />
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="text" name="last" required autocomplete="off" value="<?php echo $user_row['user_last']; ?>"/>
          </div>
        </div>
        ...
        <div class="field-wrap">
          ...
          <input type="text" name="organization" required autocomplete="off" value="<?php echo $user_row['user_organization']; ?>"/>
        </div>
        ...
        <div class="field-wrap">
          ...
          <input type="email" name="email" required autocomplete="off" value="<?php echo $user_row['user_email']; ?>"/>
        </div>

        <button type="submit" name = "submit" class="button button-block"/>Save Changes</button>
